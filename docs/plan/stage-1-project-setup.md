...
- [x] 1. Initialize a new Vite project using the Vanilla TypeScript template.
- [x] 2. Clean up the default Vite boilerplate (styles, logos, main script).
- [x] 3. Create the basic HTML layout structure in `index.html`. This should include:
...
- [x] 4. Add basic structural CSS to ensure the layout takes up the full browser window and panes are correctly sized.

## How to check that it was built
- [x] 1. Run `npm install` and `npm run dev` (or equivalent package manager commands).
- [x] 2. Open the provided localhost URL in the browser.
- [x] 3. Verify that the UI layout is visible, responsive to window resizing, and contains all the specified structural elements (editor placeholders, output placeholder, run button).
- [x] 4. Verify there are no console errors in the browser developer tools.
